...
# for tracking snake structure and position
...
# event loop and main function

def snakegame():
    game_over = False
    game_end = False

    # co-ordinates for snake
    x1 = display_width/2
    y1 = display_height/2
    ...
    while not game_over:
        while game_end == True:
            ...
            mesg = font_style.render("You lost! wanna play again? Press Y", True , redcolor)
        ...
        # updated co-ordinats with changed position
        x1 += x1_change
        y1 += y1_change
        ...
        # when the snake of the length exceeds, delete the snake_list which will end the game
